...
class DAVISTestDataset(Dataset):
    def __init__(self, root, imset='480p/type.txt', resolution=480, single_object=True, target_name=None):
        self.root = root
        if resolution == 480:
            res_tag = '480p'
        else:
        ...
        # with open('/share22/home/tangquanhui/code/STCN/DAVIS/2016/ImageSets/480p/val.txt', "r") as lines:
            for line in lines:
                _video = line.rstrip('\n')
