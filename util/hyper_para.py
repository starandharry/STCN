...
class HyperParameters():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--davis_root', help='DAVIS data root', default='/share22/home/tangquanhui/code/STCN/DAVIS')
        parser.add_argument('--inpainted_root', help='My inpainted data root', default='/share22/home/tangquanhui/code/STCN/Inpainted/OPN')

        parser.add_argument('--stage', help='Training stage (0-static images, 1-Blender dataset, 2-DAVIS+YouTubeVOS (300K), 3-DAVIS+YouTubeVOS (150K)), 4-our inpainted images', type=int, default=0)
        parser.add_argument('--num_workers', help='Number of dataloader workers per process', type=int, default=8)
