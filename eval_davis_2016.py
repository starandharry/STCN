...
parser.add_argument('--model', default='/share22/home/tangquanhui/code/STCN/STCN/saves/stcn.pth')
parser.add_argument('--davis_path', default='/share22/home/tangquanhui/code/STCN/DAVIS/2016')
parser.add_argument('--output', default='/share22/home/tangquanhui/code/STCN/Output')
...
test_dataset = DAVISTestDataset(davis_path, imset='480p/type.txt', single_object=True) # imset: actually a txt including types
